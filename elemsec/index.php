...
<?php 
	$getNumValid = query("SELECT * FROM participants_elemsec WHERE status = 'valid'");
	confirm($getNumValid);
...
<html>
    <head>
        <title>ELEMSEC - SDOIN Raffle Draw</title>
	...
	<body onload="startTime()">
		...
		<pre style="font-size: 4rem;">Elementary & Secondary</pre>
